...
function MyChart(){
  ...
  useEffect(()=>{
    try{
      const canvas = myChart.current.getContext('2d');
  ...
  return (
    <canvas id="chart-line" className="chart-canvas" height="300" ref={ myChart }></canvas>
    );
}
                ...
                <div className="card card-carousel overflow-hidden h-100 p-0">
                  <div id="carouselExampleCaptions" className="carousel slide h-100" data-bs-ride="carousel">
                    <div className="carousel-inner border-radius-lg h-100">
                      <div className="carousel-item h-100 active" style={{backgroundImage: `url(${carousel1})`,backgroundSize: 'cover'}}>
                      ...
                      <div className="carousel-item h-100" style={{backgroundImage: `url(${carousel2})`,backgroundSize: 'cover'}}>
                        <div className="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                          <div className="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                      ...
                      <div className="carousel-item h-100" style={{backgroundImage: `url(${carousel3})`,backgroundSize: 'cover'}}>
                        <div className="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                          <div className="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
